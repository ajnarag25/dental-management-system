...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2023 at 05:04 PM
...
INSERT INTO `appointments` (`appointment_id`, `user_id`, `appointment_date`, `start_time`, `end_time`, `service_name`, `service_duration`, `description`, `status`, `exp_con`, `exp_inv`, `exp_mon`, `fever`, `sore_throat`, `runny_nose`, `cough`, `diff_breath`, `nausea`, `body_ache`, `diarrhea`, `loss_smell`, `loss_taste`) VALUES
(1, 7, '2023-05-07', '23:00:00', '23:30:00', 'Fillings', 30, 'sample', 'approved', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(2, 22, '2023-05-10', '23:09:00', '23:39:00', 'Fillings', 30, 'asdasdf', 'approved', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(3, 16, '2023-05-08', '23:08:00', '00:08:00', 'Jacket Crown', 60, 'asdasdasd', 'approved', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(4, 7, '2023-05-11', '23:12:00', '00:12:00', 'Jacket Crown', 60, 'asdsdf', 'pending', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no'),
(5, 7, '2023-05-16', '20:21:00', '20:51:00', 'Check-up', 30, 'asas', 'approved', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes'),
(6, 7, '2023-05-07', '00:52:00', '01:22:00', 'Check-up', 30, 'asasas', 'approved', 'no', 'yes', 'no', 'yes', 'no', 'yes', 'no', 'no', 'yes', 'no', 'no', 'yes', 'no'),
(7, 7, '2023-05-01', '09:30:00', '10:00:00', 'Check-up', 30, 'sasasasqwq', 'approved', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no'),
(8, 7, '2023-05-12', '09:30:00', '10:00:00', 'Sealant', 30, 'ahhaahahah', 'pending', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no');
...
(7, '7.jpg', 'Danna', 'Kathreen', 'Domingo', '2017-03-02', 'Female', 'NONE', 'andreadomingo@gmail.com', '09123456789', 'Metro Manila', 'Pasig Cityyyy', 'd0d1e74e6cd427f94226726f272b6e2a5844049a', 'patient', 1, '97d33bc2d655ef3d60e1b44cd363bbff8d6d01ac', 'active'),
