...
<div class="container" style="margin: auto;">
    <a href="<?= base_url('Appointments/manualAppointments/'); ?>" class="btn btn-danger"id="back-btn" >Back</a>
    ...
    <?php echo form_open('Appointments/create_ManualAppointment_Submit/'.$this->session->userdata('user_id')) ?>
        ...
        <div class="row">
         ...
         <div class="row">
            <div class="col form-group">
                ...
                <a href="<?php echo base_url('Appointments/create_ManualAppointmentView/'.$this->session->userdata('user_id')); ?>" class="btn btn-primary" id="back"> 
