...
<div class="container">
    ...
    <?php echo form_open('Appointments/UpdateApprovedAppointment/') ?>
        ...
        <div class="row">
            <div class="col form-group">
                <a href="<?= base_url('Appointments/viewApprovedAppointments/'); ?>" class="btn btn-danger"id="back-btn" >Back</a>
                <button type=submit name="submit" class="btn btn-primary">Update Appointment</button>
                <a href="<?= base_url('Appointments/displayApprovedCovidForm/'.$appointment['appointment_id']); ?>" class="btn"id="" >View Covid Form</a>
            </div>
        </div>
