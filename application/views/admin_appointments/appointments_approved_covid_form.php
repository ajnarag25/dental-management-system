...
<div class="container" style="margin: auto;">
    ...
    echo form_open('Appointments/displayApprovedAppointment_view/'.$appointment['appointment_id']);
    ?>
        ...
        <div class="row">
         ...
         <div class="row">
            <div class="col form-group">
                ...
                <a href="<?php echo base_url('Appointments/displayApprovedAppointment_view/'.$appointment['appointment_id']); ?>" class="btn btn-primary" id="back"> 
                    Close
                </a>
            </div>
        </div></center>
