        ...
        <div class="col-md-10" style="margin: auto">
            ...
            <div style="float: right;">
                ...
                <?php echo form_open('Appointments/search/'.$status); ?>
                    ...
                    <a href="<?php echo base_url('Appointments/viewPendingAppointments'); ?>" class="btn btn-secondary">Show All</a>
                <?php echo form_close(); ?>
            </div>
            <table class = "table table-striped">
                ...
                <?php foreach($appointments as $appointment):
                    ...
                    <td>
                        <a href="<?php echo base_url('Appointments/displayPendingAppointment_view/').$appointment['appointment_id']; ?>" class="btn btn-warning" id="View">
