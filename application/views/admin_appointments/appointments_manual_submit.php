...
<div class="container" style="margin: auto;">
    ...
    <?php echo form_open('Appointments/create_ManualAppointment_done/') ?>
    ...
    <div class="row justify-content-center">
        ...
        <!-- <input type="text" class="form-control" name="fullname" id="fullname"  value="<?php  echo $status ?> " disabled/>   -->
                ...
                <a href="<?php echo base_url('Appointments/create_ManualAppointment_back/').$user_id ?>" class="btn btn-warning" id="back"> Back </a>
