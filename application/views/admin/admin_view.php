...
<div class="container">
    ...
    <div class="row"><!-- pic, name, title -->
        ...
        <div class="col-md-4">
            ...
            <center>
                <a href="<?= base_url('Admin/Edit_profilepic/').$this->session->userdata('id'); ?>">
        ...
        <div class="col-md-4">
            <h1>Dr.<?php echo $user['firstname']." ".$user['lastname'];?></h1>
            <h3>Owner Dentist</h3>
        </div>

        <div class="col-md-4">
            <a href="<?= base_url('Admin/Edit_user/').$this->session->userdata('id'); ?>" class="btn btn-primary" style="float: right;">Edit Profile</a>
            <a href="<?= base_url('Admin/Changepassword_view/').$this->session->userdata('id'); ?>" class="btn btn-danger"style="float: right; ">Reset Password</a>
        </div>
    </div>
