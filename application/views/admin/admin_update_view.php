...
<div class="row">
    <div class="col form-group">
        <a href="<?= base_url('Admin/admin_manage_accounts'); ?>" class="btn" >
        <img class="icon" id="back-chevron" src="<?php echo base_url('./uploads/images/system_images/icons/chevron-left.png'); ?>" />
        </a>
        
        <a href="<?php echo base_url('Admin/admin_update/').$user['id']; ?>"  style="float: right;"class="btn btn-warning" id="edit">Edit Profile</a>
    </div>
</div>
    <div class="row">
        <div class="col col-md-6" style="margin: auto">
            ...
            <center>
                <a href="<?= base_url('Admin/Edit_all_profilepic/').$user['id']; ?>">
