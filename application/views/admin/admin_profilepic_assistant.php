...
<div class="container">
    ...
    <?php echo form_open_multipart('Admin_Assistant/update_all_profilepic_assistant'); ?>
        ...
        <div class="row" id="btns">
            <div class="col form-group">
                <a href="<?= base_url('Admin_Assistant/admin_update_assistant/').$user['id']; ?>" class="btn btn-danger">Back</a>
                <button type=submit name="submit" class="btn btn-primary" style="float:right" id="submit-btn"disabled>Update Profile Picture</button>
