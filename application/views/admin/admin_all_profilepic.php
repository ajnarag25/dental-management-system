...
<div class="container">
    ...
    <?php echo form_open_multipart('Admin/update_all_profilepic'); ?>
        ...
        <div class="row" id="btns">
            <div class="col form-group">
                <a href="<?= base_url('Admin/admin_update/').$user['id']; ?>" class="btn btn-danger" id="back-btn"style="float: left;">Back</a>
                <button type=submit name="submit" class="btn btn-primary"style="float: right;">Update Profile Picture</button>
            </div>
        </div>
