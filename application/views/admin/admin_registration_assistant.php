...
<body>
    <div class="container">
        <?php echo form_open('Admin_Assistant/admin_signup_assistant');?>
        <!-- first row -->
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" class="form-control" value="assistant" disabled/>  
                <input type="text" class="form-control" name="role" id="role" value="assistant" hidden/>  
                <span class="field_error"><?php echo form_error('role'); ?></span>
            </div>

            <div class="form-group">
                <button type=submit name="submit" class="btn btn-primary">Sign Up</button>
                <a href="<?php echo base_url('Admin_Assistant/admin_manage_accounts_assistants'); ?>" class="btn btn-danger">Cancel</a>
            </div>
    <?php echo form_close();?>
</div>
</body>
