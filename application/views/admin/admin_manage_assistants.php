    ...
    <div class="row">
        <div class="col-md-10" style="margin: auto">
            ...
            <div style="float: left;">
                <a href="<?= base_url('Admin_Assistant/admin_registration_assistant') ?>" class="btn btn-primary" id="add_user">
                <img class="icon" src="<?php echo base_url('./uploads/images/system_images/icons/add.png'); ?>" />
                Add Assistant
                </a>
            </div>
            <div style="float: right;">
                <?php echo form_open('Admin_Assistant/search_assistant'); ?>
                    <input type="text" name="search" placeholder="Search Account">
                    <button type="submit" class="btn btn-primary">Search</button>
                    <a href="<?php echo base_url('Admin_Assistant/admin_manage_accounts_assistants'); ?>" class="btn btn-secondary">Show All</a>
                <?php echo form_close(); ?>
            </div>
                ...
                <?php foreach($users as $account): ?>
                    ...
                    ?>
                        <tr>
                            ...
                            <td >
                                <a href="<?php echo base_url('Admin_Assistant/admin_update_assistant_view/').$account['id']; ?>" class="btn btn-warning" id="edit">
                                    <img class="icon" id="view"src="<?php echo base_url('./uploads/images/system_images/icons/view.png'); ?>" />
                                    View
                                </a>

                                <?php if($account['state'] == 'active'){ ?>
                                    <a href="<?php echo base_url('Admin_Assistant/archive_account_btn/').$account['id']; ?>" class="btn btn-danger"id="delete">
                                        <img class="icon" src="<?php echo base_url('./uploads/images/system_images/icons/trash.png'); ?>" />
                                        Disable
                                    </a>
                                <?php }else{  ?>
                                    <a href="<?php echo base_url('Admin_Assistant/activate_account_btn/').$account['id']; ?>" class="btn btn-danger"id="delete">
                                        <img class="icon" src="<?php echo base_url('./uploads/images/system_images/icons/trash.png'); ?>" />
                                        Enable
                                    </a>
                              <?php   } ?>
