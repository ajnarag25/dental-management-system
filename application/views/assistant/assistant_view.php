...
<div class="container">
    ...
    <div class="row"><!-- pic, name, title -->
        ...
        <div class="col-md-4">
            ...
            <center>
                <a href="<?= base_url('Assistant/Edit_profilepic/').$this->session->userdata('id'); ?>">
        ...
        <div class="col-md-4">
            <a href="<?= base_url('Assistant/Edit_user/').$this->session->userdata('id'); ?>" class="btn btn-primary" style="float: right;">Edit Profile</a>
            <a href="<?= base_url('Assistant/Changepassword_view/').$this->session->userdata('id'); ?>" class="btn btn-danger"style="float: right; ">Reset Password</a>
