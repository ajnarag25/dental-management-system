<link rel="stylesheet" href="<?php echo base_url('assets/css/admin_nav.css'); ?>">
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/assistant_update.css'); ?>">
...
<div class="container">
    ...
    <?php echo form_open('Assistant/Assistant_changepassword'); ?>
        ...
        <div class="row">
            ...
            <a href="<?= base_url('Assistant/View_user/'.$this->session->userdata('id')); ?>" class="btn btn-danger" >Back</a>
