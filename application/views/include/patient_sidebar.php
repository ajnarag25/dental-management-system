...
<div class="sidebar">
        ...
        <div class="navgroup">
            <ul>
                ...
                <li <?php if ($active_page == 'schedule_appointment') { echo 'class="active"'; } ?>><a href="<?php echo base_url('Patient/View_user/').$this->session->userdata('id'); ?>">Schedule Appointment</a></li>
